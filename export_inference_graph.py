...
tf.app.flags.DEFINE_string(
    'model_name', 'inception_v4', 'The name of the architecture to save.')
...
tf.app.flags.DEFINE_string('dataset_name', 'pj_vehicle',
...
def main(_):
  ...
  with tf.Graph().as_default() as graph:
    ...
    preprocessing_name = FLAGS.model_name  # 预处理
    ...
    #在cpkt里面没有prediction的tensorname，只能在这里写
