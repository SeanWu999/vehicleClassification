...
def parse_args(check=True):
    ...
    # traind
    parser.add_argument('--dataset_name', type=str, default='vehicledetection')
    parser.add_argument('--dataset_dir', type=str)
    parser.add_argument('--dataset_dir_validation', type=str)
...
eval_cmd = 'python ./eval_image_classifier.py --dataset_name={dataset_name} --dataset_dir={dataset_dir_validation} --dataset_split_name={dataset_split_name} --model_name={model_name}   --checkpoint_path={checkpoint_path}  --eval_dir={eval_dir} --batch_size={batch_size}  --max_num_batches={max_num_batches}'
inference_cmd = 'python ./export_inference_graph.py --alsologtostderr --model_name={model_name} --output_file={output_file}'
...
if __name__ == '__main__':
    ...
    for i in range(30):
        ...
        # eval
        print('################    eval    ################')
        p = os.popen(eval_cmd.format(**{'dataset_name': FLAGS.dataset_name, 'dataset_dir_validation': FLAGS.dataset_dir_validation,
